...
//$(".header__sub_underline").css({opacity: 0});
  ...
  $(".header__menu_sub_item").hover(function(){
    ...
    if( $(".header__sub_underline").css("opacity") == 0) {
      $(".header__sub_underline").animate({left: left, top: default_top, width: width, opacity: 1}, {duration: 500, easing: style});
    }
...
$(!('.header__menu_content')).hover(function(){
  ...
  $(".header__menu_item").hover(function(){
    left = Math.round($(this).offset().left - $(".header__menu_content").offset().left);
    width = $(this).outerWidth();
    ...
    if( $(".header__menu_bar").css("opacity") == 0) {
      $(".header__menu_bar").css({left: left, height: default_height, width: width}, {duration: 0});
